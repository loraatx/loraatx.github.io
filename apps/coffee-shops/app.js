...
async function initOverlay() {
  if (CONFIG.overlayLabel) {
    await addOverlayControl("../../_shared/SecondData.geojson", "overlay", CONFIG.overlayLabel, CONFIG.overlayColorProperty);
  }
  if (CONFIG.overlay2Label) {
    await addOverlayControl("../../_shared/floodzone.geojson", "overlay2", CONFIG.overlay2Label, CONFIG.overlay2ColorProperty);
  }
  if (CONFIG.overlay3Label) {
    await addOverlayControl("../../_shared/Council_Districts.geojson", "overlay3", CONFIG.overlay3Label, CONFIG.overlay3ColorProperty);
  }
}
